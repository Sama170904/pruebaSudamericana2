...
public class VotoController {
    ...
    @GetMapping("/check/{tareaId}/usuario/{usuarioId}")
    public boolean yaVoto(@PathVariable("tareaId") @Min(value = 1, message = "El ID debe ser mayor a 0") Long tareaId,
            @PathVariable("usuarioId") @Min(value = 1, message = "El ID debe ser mayor a 0") Long usuarioId) {
        return votoService.yaVoto(tareaId, usuarioId);
    }
